...
## Tasks
- [ ] 1. Add tests for publish command timeout enforcement (Issue #22)
- [ ] 2. Implement timeout enforcement and `PublishCommandTimeout` in `src/bump/exec.rs` (Issue #22)
- [ ] 3. Migrate modern E2E test fixtures to `cutver.toml` (Issue #18)
- [ ] 4. Run full test suite, clippy, and verify regressions
